...
#import "CLIListMomentsResponse.h"
#import "CLIDefaultMomentResponse.h"
#import "CLICreateMomentRequest.h"
...
@interface CLIFamilyMomentsClient()
...
@implementation CLIFamilyMomentsClient
...
+ (instancetype)defaultClient {
    ...
    static CLIFamilyMomentsClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[CLIFamilyMomentsClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[CLIFamilyMomentsClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://hka75ju5ch.execute-api.us-east-1.amazonaws.com/live";
...
- (AWSTask *)momentsGet {
    ...
    return [self invokeHTTPRequest:@"GET"
                  ...
                  headerParameters:headerParameters
                              body:nil
                     responseClass:[CLIListMomentsResponse class]];
}
...
- (AWSTask *)momentsPost:(CLICreateMomentRequest *)body {
    ...
    return [self invokeHTTPRequest:@"POST"
                  ...
                  headerParameters:headerParameters
                              body:body
                     responseClass:[CLIDefaultMomentResponse class]];
}
