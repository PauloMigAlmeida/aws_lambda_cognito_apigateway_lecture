 ...
 *Objective-C*
     ...
     CLIFamilyMomentsClient *serviceClient = [CLIFamilyMomentsClient defaultClient];
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         CLIFamilyMomentsClient.registerClientWithConfiguration(configuration, forKey: "USWest2CLIFamilyMomentsClient")
 ...
 *Swift*
     ...
     let serviceClient = CLIFamilyMomentsClient(forKey: "USWest2CLIFamilyMomentsClient")

 *Objective-C*

     CLIFamilyMomentsClient *serviceClient = [CLIFamilyMomentsClient clientForKey:@"USWest2CLIFamilyMomentsClient"];
...
/**
 ...
 return type: CLIListMomentsResponse *
 */
- (AWSTask *)momentsGet;
...
/**
 ...
 return type: CLIDefaultMomentResponse *
 */
